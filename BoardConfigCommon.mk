...
ifeq ($(BOARD_USE_PHYSICAL_SUPER_PARTITION),true) # For people who want to use physical super partition
...
# Recovery
ifeq ($(BOARD_USE_PHYSICAL_SUPER_PARTITION),true)
    TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/init/fstab_super.qcom
else
...
# SELinux
ifneq ($(BOARD_USE_PHYSICAL_SUPER_PARTITION),true)
